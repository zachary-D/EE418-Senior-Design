...
/* Define to use ghostscript for rendering of embedded eps or pdf-images. */
#define GSBIT 1
...
#define PACKAGE_STRING "xfig 3.2.7b"
...
/* Define to use xpm color-bitmaps and enable import/export to xpm files. */
#define USE_XPM 1

/* Version number of package */
#define VERSION "3.2.7b"
